...
<!-- 
	...
	http://localhost:8090/WebJSP/Ex09_WebApp_RealPath.jsp -> 웹 경로
 	Ex09_WebApp_RealPath.jsp -> 실제 서버의 물리적인 경로는?
 	
 	->D:\bit2021\WebBack\WebLabs\WebJSP\WebContent\Ex09_WebApp_RealPath.jsp
 	실제 소스 : 배포 되어서 서비스 되고 있는 소스 >> 톰켓이 가지는 특정 경로
 	
 	
 	아파치 톰켓의 서비스 경로(배포)
 	D:\bit2021\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
 	
 	resourcepath >> /download/note.txt
 	소스경로 : D:\bit2021\WebBack\WebLabs\WebJSP\WebContent\note.txt
 	
 	배포경로 : D:\bit2021\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
 ...
 <%
 	...
 	out.print("ContextPath 통한 real path" + realContextPath +"<br>");
